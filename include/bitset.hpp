      ...
      private:
        ...
        public:
          ...
          proxy_iterator(pointer ptr, size_type bit_pos)
              : m_byte(ptr), m_bit(bit_pos)
          {
          }

          proxy_iterator(const proxy_iterator &other)
              : m_byte(other.m_byte), m_bit(other.m_bit)
          {
          }
      ...
      std::string to_string() const
      {
        ...
        for (size_type bit{}; bit != num_bits; ++bit)
          bin_string.push_back(
              static_cast<bool>(m_storage[bit >> 3] & static_cast<size_type>(BMASK::BIT) >> (bit & 0b00000111)) + '0');
...
template<std::size_t num_bits>
[[nodiscard]] mpl::bit::bitset<num_bits> operator&(const mpl::bit::bitset<num_bits>& lhs,
                                                   const mpl::bit::bitset<num_bits>& rhs)
{
...
template<std::size_t num_bits>
std::ostream& operator<<(std::ostream& out, const mpl::bit::bitset<num_bits>& bitset_obj)
{
